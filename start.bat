@echo off
echo ===================================================
echo       Starting Pravah AI Full Stack System
echo ===================================================
...
start "Pravah AI - Master Python Backend (5000)" cmd /k "python src\backend_api\main.py"

ping 127.0.0.1 -n 3 >nul

echo [2/2] Starting Web Application and API Gateway (Port 3000)...
start "Pravah AI - Express Gateway (3000)" cmd /k "cd src\backend_api && node SERVER.JS"
